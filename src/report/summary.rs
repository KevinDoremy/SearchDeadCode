...
pub fn rule_label(rule: &str) -> &'static str {
    {
        match rule {
            ...
            "DC004" => "Unused imports",
            "DC005" => "Unused enum cases",
            "DC006" => "Redundant public",
            "DC007" => "Dead branches",
            "DC008" => "Unused sealed variants",
            "DC009" => "Redundant overrides",
            "DC010" => "Write-only preferences",
            "DC011" => "Write-only DAO",
            "DC012" => "Duplicate imports",
